...
![Регистрация и вход](HW3/demo_and_deploy/1_register_login.gif)

### 2. 🔗 Создание короткой ссылки и редирект
![Сокращение и редирект](HW3/demo_and_deploy/2_shorted_redirect.gif)

### 3. 🔍 Поиск по оригинальному URL + статистика
![Поиск по оригинальному URL и статистика](HW3/demo_and_deploy/3_search_original_stats.gif)

### 4. ♻️ Возобновление, обновление и просмотр статистики
![Разархивация и обновление ссылок](HW3/demo_and_deploy/4_revive_update_short_stats.gif)

### 🚀 Локальный деплой через Docker + Swagger UI
![Деплой](HW3/demo_and_deploy/deploy.png)
